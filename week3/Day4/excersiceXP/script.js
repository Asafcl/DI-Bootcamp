...
//     else{
//         console.log('no problem, i love cats');
//     }
...
// if( userNumber % 2 === 0 ){
//     console.log(userNumber + ' is a even number')} 
//     else{
...
// if (users.length === 2) console.log(users[0] + 'and' + users[1] + 'no one is online');
// if (users.length >= 3) console.log (` ${users[0]} and ${users[1]} and ${users.length - 2 } more` );